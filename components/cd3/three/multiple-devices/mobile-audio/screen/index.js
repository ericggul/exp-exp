...
import useSocket from "utils/hooks/socket/cd3/mobile-audio/useSocketScreen";
import { Canvas, useFrame } from "@react-three/fiber";
import { OrbitControls, Environment, Instances, Instance } from "@react-three/drei";
import { QRCodeSVG } from "qrcode.react";
import * as THREE from "three";

const QR_URL = "https://exp-exp.onrender.com/cd3/three/multiple-devices/mobile-audio/mobile";
